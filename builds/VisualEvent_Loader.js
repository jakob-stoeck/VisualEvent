...
VisualEvent_Loader.prototype = {
	...
	"_construct": function ()
	{
		...
		/* Load the required files - note that the token https://raw.github.com/jakob-stoeck/VisualEvent/master/builds/VisualEvent-1361543544 is replaced by the build
		 * script with the location of the combined Visual Event file (i.e. with the parsers included
		 */
		this._loadFile( 'https://raw.github.com/jakob-stoeck/VisualEvent/master/builds/VisualEvent-1361543544/css/VisualEvent.css', 'css' );
		if ( typeof jQuery == 'undefined' ) {
			this._loadFile( 'https://raw.github.com/jakob-stoeck/VisualEvent/master/builds/VisualEvent-1361543544/js/VisualEvent-jQuery.js', 'js' );
		}
		else {
			this._loadFile( 'https://raw.github.com/jakob-stoeck/VisualEvent/master/builds/VisualEvent-1361543544/js/VisualEvent.js', 'js' );
		}
	},
